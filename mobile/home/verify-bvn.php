            ...
            <div class="content">
                ...
                <form method="post" class="verifyForm" id="verifyForm" action="verify-bvn">
                        <fieldset>
                            ...
                            <div class="input-style input-style-always-active has-borders mb-4">
                                ...
                                <select onchange="getPo()" id="networkid" name="network">
                                    <option value="" disabled="" selected="">~Select Slip Design~</option>
                                        <option data-price=500 value="regular">Information Slip</option>
                                </select>
                            ...
                            <button type="submit" id="verify-bvn" name="verify-bvn" class="btn btn-info btn-lg btn-block" style="background-color:<?php echo $sitecolor; ?>;">
                                   Verify BVN
                            </button>
                            </div>
                        </fieldset>
