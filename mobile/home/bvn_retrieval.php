<div class="page-content header-clear-medium">
    <div class="card card-style">
        <div class="content mb-0">
            ...
            <h1 class="text-center">BVN Retrieval</h1>
            <p class="text-center mb-3">Retrieve your BVN details</p>
        </div>
    </div>
    <div class="card card-style">
        <div class="content">
            <form method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="input-style input-style-always-active has-borders validate-field mb-4">
                        <label class="color-theme opacity-80 font-700 font-12">Reason/Notes</label>
                        <textarea name="reason" placeholder="Additional details" class="round-small" rows="3" required></textarea>
                    </div>
                    <div class="mb-4">
                        <label class="color-theme opacity-80 font-700 font-12 d-block mb-1">Upload Valid ID Card (NIN Slip, Driver's License, etc.)</label>
                        <input type="file" name="id_card" class="form-control" accept="image/*,application/pdf" required>
                    </div>
                    <div class="input-style input-style-always-active has-borders validate-field mb-4">
                    ...
                    <input name="modification_type_code" type="hidden" value="bvn_retrieval">
