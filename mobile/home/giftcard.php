<div class="page-content header-clear-medium">
        ...
        <div class="card card-style">
            ...
            <div class="content">
                ...
                <p class="mb-0 mt-2 text-center font-600 color-highlight">Receive payment into your Nigerian bank account in few minutes if you sell your Gift card to us</p>
                <h1 class="text-center">Buy or Redeem your gift card here in few steps</h1>
                
                <hr/>
                <?php if($controller->getConfigValue($data,"airtime2cashstatus") <> "On"): ?>
                <h3 class="text-danger text-center">Sorry, This feature will be available soon... </h3>
                <?php else: ?>
