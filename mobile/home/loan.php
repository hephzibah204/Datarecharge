<div class="page-content header-clear-medium">
        ...
        <div class="card card-style">
            ...
            <div class="content">
                ...
                <p class="mb-0 mt-2 text-center font-600 color-highlight">Minimum Loan ₦1,000</p>
                <h1 class="text-center">Get up to ₦500,000 under 5 minutes</h1>
                
                <hr/>
                <?php if($controller->getConfigValue($data,"airtime2cashstatus") <> "On"): ?>
                <h3 class="text-danger text-center">Sorry, you are not eligible to have a loan right now you need to be active on Keytopup for at least 2 months to qualify.</h3>
                <?php else: ?>
