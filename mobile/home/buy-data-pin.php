        ...
        <div class="col-sm-6 text-black">
          ...
          <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
            ...
            <form style="width: 23rem;">
              ...
              <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Data Card</h3>

              <div class="form-outline mb-4">
                  <label class="form-label" for="form2Example18">Select Network</label>
                <select class="form-control" id="datanetworkid" name="network">
              ...
              <div class="form-outline mb-4">
                ...
                <select class="form-control" id="datapingroup" name="datagroup">
             ...
             <!--div class="form-outline mb-4">
              <label class="form-label" for="form2Example28">Phone numeber</label>
              ...
              <div class="form-outline mb-4">
                ...
                <input type="number" name="quantity" placeholder="~Quantity~" class="form-control form-control-lg" id="datapinquantity" required />
                
              </div>
              
              <div class="form-outline mb-4">
                  <label class="form-label" for="form2Example28">Business Name</label>
                <input type="text" name="businessname" placeholder="~Business Name~"  class="form-control form-control-lg" id="businessname" required />
                
              </div>

              <div class="pt-1 mb-4">
                <button class="btn btn-info btn-lg btn-block" style="background-color:<?php echo $sitecolor; ?>;" type="submit" id="datapin-btn" name="purchase-datapin">Generate Pin</button>
              </div>
