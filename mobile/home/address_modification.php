<div class="page-content header-clear-medium">
    ...
    <div class="card card-style">
        <div class="content">
            <form method="post" action="address_modification">
                <fieldset>
                    <div class="input-style input-style-always-active has-borders validate-field mb-4">
                        <label class="color-theme opacity-80 font-700 font-12">New Address</label>
                        <textarea name="new_value" placeholder="Enter your new residential address" class="round-small" rows="3" required></textarea>
                    </div>
                    <div class="input-style input-style-always-active has-borders validate-field mb-4">
                    ...
                    <div class="input-style input-style-always-active has-borders validate-field mb-4">
                        ...
                        <input type="text" value="â‚¦4,000" class="round-small" readonly>
                    </div>
