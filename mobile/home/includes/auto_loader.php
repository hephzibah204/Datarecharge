...
require_once($baseDir . "/core/helpers/vendor/autoload.php");
require_once($baseDir . "/core/helpers/vendor/site.php");
require_once($baseDir . "/core/helpers/vendor/manifest.php");
