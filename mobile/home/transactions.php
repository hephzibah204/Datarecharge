            ...
            <?php if(!empty($data)){ $i=1; foreach($data as $list){   ?>
                ...
                <a href="transaction-details?ref=<?php echo $list->transref; ?>" class="d-flex">
                    <div class="align-self-center">
                        ...
                        <span class="icon icon-s gradient-blue color-white rounded-sm shadow-xxl"><i class="fa fa-credit-card font-15"></i></span>
                        <?php else: ?>
                    ...
                    <div class="ms-auto text-end align-self-center">
                       ...
                       <?php if($list->servicename == "Virtual Card"){ ?>
                        <h5 class="color-theme font-15 font-700 d-block mb-n1">$<?php echo $list->amount; ?></h5>
                        <?php } else {?>
