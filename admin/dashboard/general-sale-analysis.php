                ...
                <div class="col-12 col-lg-4">
                    <div class="box-body br-1 border-light no-radius">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <p class="mb-0 text-muted text-right"><b>Paga Funding</b></p>
                                <h2 class="text-primary my-0 text-right">N<?php echo $data["PagaFunding"]; ?> </h2>
                                <p class="mb-0 text-dark text-right">(<?php echo $data["PagaTransactions"]; ?> Transactions)</p>
                            </div>
                        </div>
                    </div>
                </div>
