<div class="row">
  <div class="col-12">
    <div class="box">
      ...
      <!-- /.box-header -->
      <div class="box-body">
        <form method="POST" class="m-3 form-submit-icon">
          <p class="text-danger mb-0 mt-0"><b>Note: Type User Email, Phone Number, Or Name</b></p>
          <div class="d-flex justify-content-between align-items-center">

            <input type="text" name="user" placeholder="Type User Email, Phone Number, Or Name" class="btn-rounded form-control" required>
            <button type="submit" name="search-user" class="btn btn-submit-icon btn-primary btn-rounded ml-3"><i class="fa fa-search"></i></button>
