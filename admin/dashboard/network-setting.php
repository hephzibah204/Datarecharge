...
<div class="col-12">
    ...
    <div class="box-header with-border d-flex align-items-center justify-content-between">
        ...
        <?php foreach($data AS $network): if($network->network == $_GET["network"]): ?>
                ...
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Data Share</label>
                    <div class="">
                ...
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Data Share ID</label>
                    <div class="">
