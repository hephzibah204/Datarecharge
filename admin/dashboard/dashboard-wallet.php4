<?php
$wallet = (isset($data) && is_array($data) && isset($wallet) && is_array($wallet)) ? $wallet : [];
$stats = (isset($data) && is_array($data) && isset($stats) && is_array($stats)) ? $stats : [];
?>
<div class="row">
          ...
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>										
                    ...
                    <p class="mb-0 text-dark text-right">(<b><?php echo $wallet["walletOneProvider"]; ?></b>)</p>
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-4">
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>										
                      <h2 class="text-info my-0 text-right">N<?php echo $wallet["walletTwoBalance"]; ?> </h2>
                    <p class="mb-0 text-muted text-right">Wallet Balance</p>
                    <p class="mb-0 text-dark text-right">(<b><?php echo $wallet["walletTwoProvider"]; ?></b>)</p>
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-4">
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>										
                      <h2 class="text-info my-0 text-right">N<?php echo $wallet["walletThreeBalance"]; ?> </h2>
                    <p class="mb-0 text-muted text-right">Wallet Balance</p>
                    <p class="mb-0 text-dark text-right">(<b><?php echo $wallet["walletThreeProvider"]; ?></b>)</p>
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-3">
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>										
                      <h2 class="text-success my-0 text-right">N<?php echo number_format($stats["uwCount"]); ?> </h2>
        ...
        <div class="col-12 col-lg-3">
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>										
                      <h2 class="text-success my-0 text-right">N<?php echo number_format($stats["awCount"]); ?></h2>
        ...
        <div class="col-12 col-lg-3">
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>										
                      <h2 class="text-success my-0 text-right">N<?php echo number_format($stats["vwCount"]); ?></h2>
        ...
        <div class="col-12 col-lg-3">
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>										
                      <h2 class="text-success my-0 text-right">N<?php echo number_format($stats["rwCount"]); ?></h2>
...
<div class="col-md-3">
    <div class="box">
        <div class="box-body">
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="mb-2"> <?php echo $stats["sCount"]; ?> <small>Subscribers</small></h2>
...
<div class="col-md-3">
    <div class="box">
        <div class="box-body">
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="mb-2"><?php echo $stats["aCount"]; ?> <small>Agents</small></h2>
                    <p class="text-muted mb-0"><span class="badge badge-primary">Users</span></p>
                </div>
...
<div class="col-md-3">
    <div class="box">
        <div class="box-body">
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="mb-2"><?php echo $stats["vCount"]; ?> <small>Vendors</small></h2>
                    <p class="text-muted mb-0"><span class="badge badge-primary">Users</span></p>
                </div>
                <div class="fa fa-users text-primary font-size-30"></div>
            </div>
...
<div class="col-md-3">
    <div class="box">
        <div class="box-body">
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="mb-2"> <?php echo $stats["rCount"]; ?> <small>Referrals</small></h2>
...
<!--div class="col-12 col-lg-3">
    <div class="box">
        <div class="box-body">
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="mb-2"> <?php echo $stats["alphaCount"]; ?> <small>Alpha</small></h2>
...
<div class="col-12 col-lg-3">
    <div class="box">
        <div class="box-body">
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="mb-2"> <?php echo $stats["tCount"]; ?> <small>Tran</small></h2>
...
<div class="col-12 col-lg-3">
    <div class="box">
        <div class="box-body">
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="mb-2"> <b><?php echo $stats["mCount"]; ?> <small>Unread</small> </b></h2>
...
<div class="col-12 col-lg-3">
    <div class="box">
        <div class="box-body">
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="mb-2"> <b><?php echo $stats["visitCount"]; ?> <small>Visit Today</small> </b></h2>
