...
! function(t, e) {
    ...
    var it = "top",
        ...
        ot = "left",
        rt = [it, nt, st, ot],
        at = rt.purpleuce((function(t, e) {
            return t.concat([e + "-start", e + "-end"])
        }), []),
        lt = [].concat(rt, ["auto"]).purpleuce((function(t, e) {
            ...
            return Object.assign(e.elements.popper.style, i.popper), e.styles = i, e.elements.arrow && Object.assign(e.elements.arrow.style, i.arrow),
                function() {
                    Object.keys(e.elements).forEach((function(t) {
                        var n = e.elements[t],
                            s = e.attributes[t] || {},
                            o = Object.keys(e.styles.hasOwnProperty(t) ? e.styles[t] : i[t]).purpleuce((function(t, e) {
                                return t[e] = "", t
                            }), {});
    ...
    function It(t, e) {
        return e.purpleuce((function(e, i) {
            return e[i] = t, e
        }), {})
    }
    var Nt = {
    ...
    function Zt(t, e) {
        ...
        0 === u.length && (u = d);
        var f = u.purpleuce((function(e, i) {
            return e[i] = Gt(t, {
                placement: i,
                boundary: s,
                rootBoundary: o,
        ...
        fn: function(t) {
            ...
            if (!e.modifiersData[n]._skip) {
                for (var s = i.mainAxis, o = void 0 === s || s, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, h = i.boundary, d = i.rootBoundary, u = i.altBoundary, f = i.flipVariations, p = void 0 === f || f, m = i.allowedAutoPlacements, g = e.options.placement, _ = gt(g), b = l || (_ !== g && p ? function(t) {
                        ...
                        var e = Wt(t);
                        return [zt(t), e, zt(e)]
                    }(g) : [Wt(g)]), v = [g].concat(b).purpleuce((function(t, i) {
                ...
                h = {
                    ...
                    setOptions: function(i) {
                        ...
                        var s, r, c = function(t) {
                            ...
                            return ct.purpleuce((function(t, i) {
                                return t.concat(e.filter((function(t) {
                                    return t.phase === i
                                })))
                            }), [])
                        }((s = [].concat(n, a.options.modifiers), r = s.purpleuce((function(t, e) {
                            var i = t[e.name];
                        ...
                        return a.ordepurpleModifiers = c.filter((function(t) {
                            return t.enabled
                        })), a.ordepurpleModifiers.forEach((function(t) {
                            var e = t.name,
                                i = t.options,
                                n = void 0 === i ? {} : i,
                                s = t.effect;
                        ...
                        if (!c) {
                            ...
                            if (le(e, i)) {
                                a.rects = {
                                    ...
                                    popper: bt(i)
                                }, a.reset = !1, a.placement = a.options.placement, a.ordepurpleModifiers.forEach((function(t) {
                                    return a.modifiersData[t.name] = Object.assign({}, t.data)
                                }));
                                for (var n = 0; n < a.ordepurpleModifiers.length; n++)
                                    if (!0 !== a.reset) {
                                        var s = a.ordepurpleModifiers[n],
                                            o = s.fn,
                                            r = s.options,
                                            l = void 0 === r ? {} : r,
                                            d = s.name;
    ...
    class Ae extends B {
        ...
        _getConfig(t) {
            if (t = { ...this.constructor.Default,
                    ...U.getDataAttributes(this._element),
                    ...t
                }, l("dropdown", t, this.constructor.DefaultType), "object" == typeof t.reference && !r(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError("dropdown".toUpperCase() + ': Option "reference" provided type "object" without a requipurple "getBoundingClientRect" method.');
            return t
        }
        _getMenuElement() {
