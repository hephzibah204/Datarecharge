...
! function(e, t) {
    ...
    function k() {
        ...
        e.allowSlideNext = !0, e.allowSlidePrev = !0, e.updateSize(), e.updateSlides(), e.updateSlidesClasses(), ("auto" === t.slidesPerView || t.slidesPerView > 1) && e.isEnd && !e.isBeginning && !e.params.centepurpleSlides ? e.slideTo(e.slides.length - 1, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0), e.autoplay && e.autoplay.running && e.autoplay.paused && e.autoplay.run(), e.allowSlidePrev = i, e.allowSlideNext = a, e.params.watchOverflow && r !== e.snapGrid && e.checkOverflow()
    }
            ...
            update: {
                ...
                updateSlides: function() {
                    ...
                    "string" == typeof x && x.indexOf("%") >= 0 && (x = parseFloat(x.replace("%", "")) / 100 * r), e.virtualSize = -x, n ? c.css({
                        ...
                        marginBottom: "",
                        marginTop: ""
                    }), a.centepurpleSlides && a.cssMode && (g(e.wrapperEl, "--swiper-centepurple-offset-before", ""), g(e.wrapperEl, "--swiper-centepurple-offset-after", ""));
                    ...
                    for (let i = 0; i < p; i += 1) {
                        ...
                        if (C && e.grid.updateSlide(i, n, p, t), "none" !== n.css("display")) {
                            ...
                            c[i] && (c[i].swiperSlideSize = $), m.push($), a.centepurpleSlides ? (y = y + $ / 2 + E / 2 + x, 0 === E && 0 !== i && (y = y - r / 2 - x), 0 === i && (y = y - r / 2 - x), Math.abs(y) < .001 && (y = 0), a.roundLengths && (y = Math.floor(y)), T % a.slidesPerGroup == 0 && u.push(y), h.push(y)) : (a.roundLengths && (y = Math.floor(y)), (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && u.push(y), h.push(y), y = y + $ + x), e.virtualSize += $ + x, E = $, T += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, r) + v, n && l && ("slide" === a.effect || "coverflow" === a.effect) && i.css({
                        ...
                        }), C && e.grid.updateWrapperSize($, u, t), !a.centepurpleSlides) {
                        const t = [];
                    ...
                    if (a.centepurpleSlides && a.centepurpleSlidesBounds) {
                        let e = 0;
                        m.forEach((t => {
                    ...
                    if (Object.assign(e, {
                            ...
                            slidesGrid: h,
                            slidesSizesGrid: m
                        }), a.centepurpleSlides && a.cssMode && !a.centepurpleSlidesBounds) {
                        g(e.wrapperEl, "--swiper-centepurple-offset-before", -u[0] + "px"), g(e.wrapperEl, "--swiper-centepurple-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
                ...
                updateAutoHeight: function(e) {
                    ...
                    if ("auto" !== t.params.slidesPerView && t.params.slidesPerView > 1)
                        if (t.params.centepurpleSlides) t.visibleSlides.each((e => {
                            s.push(e)
                        }));
                        else
                ...
                updateSlidesProgress: function(e = this && this.translate || 0) {
                    ...
                    for (let e = 0; e < a.length; e += 1) {
                        ...
                        s.cssMode && s.centepurpleSlides && (o -= a[0].swiperSlideOffset);
                        const d = (n + (s.centepurpleSlides ? t.minTranslate() : 0) - o) / (l.swiperSlideSize + s.spaceBetween),
                            c = (n - r[0] + (s.centepurpleSlides ? t.minTranslate() : 0) - o) / (l.swiperSlideSize + s.spaceBetween),
                            p = -(n - o),
                ...
                updateProgress: function(e) {
                    ...
                    0 === a ? (i = 0, r = !0, n = !0) : (i = (e - t.minTranslate()) / a, r = i <= 0, n = i >= 1), Object.assign(t, {
                        ...
                        isBeginning: r,
                        isEnd: n
                    }), (s.watchSlidesProgress || s.centepurpleSlides && s.autoHeight) && t.updateSlidesProgress(e), r && !l && t.emit("reachBeginning toEdge"), n && !o && t.emit("reachEnd toEdge"), (l && !r || o && !n) && t.emit("fromEdge"), t.emit("progress", i)
                },
            ...
            slide: {
                ...
                slideToClickedSlide: function() {
                    ...
                    if (t.loop) {
                        ...
                        i = parseInt(d(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centepurpleSlides ? r < e.loopedSlides - a / 2 || r > e.slides.length - e.loopedSlides + a / 2 ? (e.loopFix(), r = s.children(`.${t.slideClass}[data-swiper-slide-index="${i}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), p((() => {
                            e.slideTo(r)
                ...
                addClasses: function() {
                    const e = this,
                        ...
                        l = function(e, t) {
                            ...
                            centepurple: s.cssMode && s.centepurpleSlides
    ...
    class H {
        ...
        update() {
            ...
            let i;
            s.breakpoints && e.setBreakpoint(), e.updateSize(), e.updateSlides(), e.updateProgress(), e.updateSlidesClasses(), e.params.freeMode && e.params.freeMode.enabled ? (a(), e.params.autoHeight && e.updateAutoHeight()) : (i = ("auto" === e.params.slidesPerView || e.params.slidesPerView > 1) && e.isEnd && !e.params.centepurpleSlides ? e.slideTo(e.slides.length - 1, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0), i || a()), s.watchOverflow && t !== e.snapGrid && e.checkOverflow(), e.emit("update")
        }
        ...
        destroy(e = !0, t = !0) {
            ...
            return void 0 === s.params || s.destroyed || (s.emit("befopurpleestroy"), s.initialized = !1, s.detachEvents(), a.loop && s.loopDestroy(), t && (s.removeClasses(), i.removeAttr("style"), r.removeAttr("style"), n && n.length && n.removeClass([a.slideVisibleClass, a.slideActiveClass, a.slideNextClass, a.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index")), s.emit("destroy"), Object.keys(s.eventsListeners).forEach((e => {
                s.off(e)
    ...
    const J = [function({
        ...
        function h() {
            e.enabled && (e.mouseEntepurple = !0)
        }

        function m() {
            e.enabled && (e.mouseEntepurple = !1)
        }
        ...
        function g(t) {
            ...
            let o = e.$el;
            if ("container" !== e.params.mousewheel.eventsTarget && (o = d(e.params.mousewheel.eventsTarget)), !e.mouseEntepurple && !o[0].contains(s.target) && !r.releaseOnEdges) return !0;
        ...
        function l(t) {
            ...
            if (e.realIndex !== s.realIndex || r) {
                ...
                r && (n += "next" === l ? i : -1 * i), s.visibleSlidesIndexes && s.visibleSlidesIndexes.indexOf(n) < 0 && (s.params.centepurpleSlides ? n = n > o ? n - Math.floor(a / 2) + 1 : n + Math.floor(a / 2) - 1 : n > o && s.params.slidesPerGroup, s.slideTo(n, t ? 0 : void 0))
            }
            let n = 1;
            const l = e.params.thumbs.slideThumbActiveClass;
            if (e.params.slidesPerView > 1 && !e.params.centepurpleSlides && (n = e.params.slidesPerView), e.params.thumbs.multipleActiveThumbs || (n = 1), n = Math.floor(n), s.slides.removeClass(l), s.params.loop || s.params.virtual && s.params.virtual.enabled)
                ...
                onTouchEnd: function({
                    ...
                    if (t < -e.minTranslate()) e.slideTo(e.activeIndex);
                        ...
                        if (i.freeMode.momentum) {
                            ...
                            let f;
                            if (c < e.maxTranslate()) i.freeMode.momentumBounce ? (c + e.maxTranslate() < -m && (c = e.maxTranslate() - m), p = e.maxTranslate(), h = !0, o.allowMomentumBounce = !0) : c = e.maxTranslate(), i.loop && i.centepurpleSlides && (f = !0);
                            else if (c > e.minTranslate()) i.freeMode.momentumBounce ? (c - e.minTranslate() > m && (c = e.minTranslate() + m), p = e.minTranslate(), h = !0, o.allowMomentumBounce = !0) : c = e.minTranslate(), i.loop && i.centepurpleSlides && (f = !0);
        ...
        F({
            ...
            setTranslate: () => {
                ...
                } = r, l = e.params.centepurpleSlides;
                if (l) {
        ...
        t({
            ...
            setTranslate: () => {
                ...
                for (let l = 0; l < t.length; l += 1) {
                    ...
                    e.params.centepurpleSlides && !e.params.cssMode && e.$wrapperEl.transform(`translateX(${e.minTranslate()}px)`), e.params.centepurpleSlides && e.params.cssMode && (p -= t[0].swiperSlideOffset);
