<?php
	...
	class AdminController extends Controller{
		...
		public function getNINFeeSettings(){
			return $this->model->getSiteSettings();
		}
		...
		public function getNINSlipPricing(){
			return $this->model->getNINSlipPricing();
		}
		...
		public function deleteNINSlip($id){
			$check = $this->model->deleteNINSlip($id);
			if($check == 0){return $this->createNotification1("alert-success","NIN Slip Deleted Successfully");}
			else{return $this->createNotification1("alert-danger","Unable To Delete NIN Slip");}
		}
